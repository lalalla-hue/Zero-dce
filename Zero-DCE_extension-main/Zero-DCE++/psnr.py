...
def main():
    ...
    folder_GT = '/home/lh/datasets/LOLdataset/eval15/high_unifsize'
    folder_Gen = '/home/lh/Zero-DCE_extension-main/Zero-DCE++/data/result_Zero_DCE++/lol_unifsize'
##
    # save the psnr and ssim score by txt
    PS_path = '/home/lh/Zero-DCE_extension-main/Zero-DCE++/data/score'
    if not os.path.exists(PS_path):
        print('NO_path to sava the NIQE_Score,Making....')
        os.makedirs(PS_path)
    else:
        print("The NIQE_Score_path has existed")
    PS_txt = open(PS_path + '/scorelol.txt', 'a')
    ...
    #img_list = os.listdir('/home/lh/Zero-DCE_extension-main/Zero-DCE++/data/Label_unifsize')
    #img_list = glob.glob('/home/lh/Zero-DCE_extension-main/Zero-DCE++/data/Label_unifsize/*.JPG')
    #print(img_list)
    #print(sorted(img_list, key=os.path.getctime))
    img_list =sorted(glob.glob(os.path.join(folder_GT , '*.png')), key=lambda x: float(re.findall("([0-9]+?)\.png", x)[0]))
    print(img_list)
    ...
    for i, img_path in enumerate(img_list):
        ...
        #img1_list=os.path.join(folder_Gen)
       # print(img1_list)
       ...
       # cropped_GT=mat(cropped_GT)
        #cropped_Gen=mat(cropped_Gen)
